...
def _write_agent_scaffold(agent_dir: Path, scaffold: _AgentScaffold) -> None:
    ...
    (agent_dir / "agent.py").write_text(
        ...
        f'    """Personal agent generated by North."""\n',
        encoding="utf-8",
    )
...
def create_agent(
    ...
    output_dir: Path | None = typer.Option(
        None,
        "--output-dir",
        help="Agent folder to create in (default: NORTH_HOME/agents/)",
    ),
) -> None:
    ...
    uses_runtime_directory = output_dir is None
    output_dir = settings.north_home / "agents" if uses_runtime_directory else output_dir.resolve()
    ...
    typer.echo("  Packaged prompts were left unchanged.")
    if uses_runtime_directory:
        typer.echo("\nNorth will auto-discover this agent on the next routed request.")
    else:
        typer.echo("\nCustom output directories are not auto-discovered by North.")
