    ...
    for model_id, info in models.items():
        ...
        out.append(
            ModelFacts(
                ...
                supports_completion=fact(ModelCapability.COMPLETION in caps, Rank.INFERRED, INFERRED_SOURCE, when),
                supports_tools=fact(ModelCapability.TOOL_CALLS in caps, Rank.INFERRED, INFERRED_SOURCE, when),
                supports_reasoning=fact(ModelCapability.REASONING in caps, Rank.INFERRED, INFERRED_SOURCE, when),
                ...
                supports_structured=fact(ModelCapability.COMPLETION in caps, Rank.INFERRED, INFERRED_SOURCE, when),
